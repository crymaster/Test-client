...
public class CroppedResolutionPolicy extends BaseResolutionPolicy {
	...
	private float mMarginVertical; // Pixels from top of canvas to visible area,
									// and from bottom of canvas to visible area
	private float mMarginHorizontal; // Pixels from left of canvas to visible
										// area, and from right of canvas to
										// visible area
	...
	public CroppedResolutionPolicy(final float nCameraWidth,
			final float nCameraHeight) {
	...
	public void onMeasure(Callback pResolutionPolicyCallback,
		...
		final float nCanvasRatio = (float) measuredWidth
		...
		pResolutionPolicyCallback.onResolutionChanged(measuredWidth,
				measuredHeight);
	}
