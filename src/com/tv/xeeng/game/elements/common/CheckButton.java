...
public abstract class CheckButton extends GroupEntity {

	private TiledSprite mCheckSprite;
	private XeengText mTitleTxt;
	private boolean mIsChecked;

	public CheckButton(float pX, float pY, ITiledTextureRegion mCheckTTR,
	...
	public abstract void onCheckChange(CheckButton pCheckButton);
	...
	private OnClickListener mOnClickListener = new OnClickListener() {
		...
		public void onClick(TouchableEntity pTouchableEntity) {
			...
			CheckButton.this.check(!mIsChecked);
			onCheckChange(CheckButton.this);
		}
	};
}
