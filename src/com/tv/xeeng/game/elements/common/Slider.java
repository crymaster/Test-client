...
public abstract class Slider extends GroupEntity {

	private ClipEntity mActiveClipEntity;
	private Sprite mBg, mActive, mIndicator;
	private float mProgress;

	public Slider(float pX, float pY, ITextureRegion pBgTR,
	...
	public abstract void onSliderChange(Slider pSlider);
